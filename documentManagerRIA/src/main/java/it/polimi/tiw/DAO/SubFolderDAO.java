...
public class SubFolderDAO {
    ...
    public boolean deleteSubFolder(String username, String folderName, String subFolderName) throws SQLException{
        String query = "delete from subfolder where username = ? and folderName = ? and subFolderName = ?";
        PreparedStatement pstatement = null;
        int code;
