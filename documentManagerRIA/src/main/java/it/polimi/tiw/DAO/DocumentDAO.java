...
public class DocumentDAO {
    ...
    public boolean deleteDocument(String username, String folderName, String subFolderName, String documentName, String type) throws SQLException {
        String query = "delete from document where username = ? and folderName = ? and subFolderName = ? and documentName = ? and type = ?";
        PreparedStatement pstatement = null;
        int code;
